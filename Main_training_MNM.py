...
if __name__ == '__main__':
    ...
    parser.add_argument('--modeldir', type=str, default='data/MNM_color_6tasks_8per-ring_')
    ...
    train(args.modeldir,
        ...
        #ruleset='MNM_color_6tasks_1240',
        #rule_trains=['MNM_color_1240','overlap','zero_gap','gap','odr','odrd','gap500',],
        display_step=20,
