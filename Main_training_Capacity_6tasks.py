...
if __name__ == '__main__':
    ...
    parser.add_argument('--modeldir', type=str, default='data/Capacity_stim_on_different_rings_6tasks')
    ...
    train(args.modeldir,
        seed=args.seed,
        hp=hp,
        ruleset='Capacity_6tasks',
        rule_trains=['Capacity_color','overlap','zero_gap','gap','odr','odrd','gap500',],
        display_step=20,
