...
from analysis.Analyze_Capacity_PSTH_multistim_withinRF import analyze_Capacity_multistim_withinRF_PSTH
...
if __name__ == "__main__":
    ...
    # analyze_Capacity_multistim_withinRF_PSTH(hp,log,model_dir,model_list,rule,norm=False)
    ######################################
    ...
    H_dict, task_info_dict = compute_H(hp,log,model_dir,rule,models_selected[rule],task_mode='multistim_withinRF')


    analyze_Capacity_multistim_withinRF_PSTH(hp,log,model_dir,models_selected[rule],rule,\
