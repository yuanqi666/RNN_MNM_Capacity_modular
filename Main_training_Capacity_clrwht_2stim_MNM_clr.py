...
if __name__ == '__main__':
    ...
    parser.add_argument('--modeldir', type=str, default='data/Capacity_clrwht_2stim_MNM_clr')
    ...
    train(args.modeldir,
        seed=args.seed,
        hp=hp,
        ruleset='Capacity_clrwht_2stim_MNM_clr_6tasks',
        rule_trains=['Capacity_color_2_stims_white_stims','MNM_color',],
        display_step=500,
